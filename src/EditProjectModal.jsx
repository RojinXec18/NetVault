    ...
    <div className="modal-overlay">
      <div className="modal-content">
        <div className="modal-header">
          <h2 style={{ margin: 0, fontSize: '1.4rem', textShadow: '0 0 5px var(--accent-cyan)' }}>Edit Architecture</h2>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-actions">
            ...
            <button type="submit" className="glow-btn success">Save Changes</button>
          </div>
        </form>
      </div>
    </div>
